...
def get_config_options():
    ...
    namespaces.add_cli(
        ...
        "We could also include all documents from any "
        "collection in the \"test\" database and all "
        "\"foo\" collections from any database by using "
        "a wildcard such as `-n test.*,*.foo`. "
    ...
    namespaces.add_cli(
        ...
        "We could also exclude all documents from any "
        "collection in the \"test\" database and all "
        "\"foo\" collections from any database by using "
        "a wildcard such as `-x test.*,*.foo`. "
